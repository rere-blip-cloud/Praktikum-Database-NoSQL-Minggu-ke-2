"""
mqtt_sub_latihan.py
Subscriber: terima data dari 'pabrik/produksi', hitung reject rate,
tambahkan timestamp & flag peringatan, lalu simpan ke MongoDB.


Broker  : broker.hivemq.com (publik, port 1883)
MongoDB : localhost:27017  →  db: pabrik_iot  →  col: produksi_mqtt
"""
